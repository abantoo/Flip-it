    ...
    <form @submit.prevent="handleRegister" class="space-y-6 py-2">
      ...
      <div class="space-y-4">
        <label class="flex items-start gap-3 cursor-pointer group">
          ...
          <span class="text-sm font-medium text-slate-600 group-hover:text-slate-900 leading-tight">
            I agree to the <a href="#" class="font-bold text-slate-900 underline">Terms of Service</a> and <a href="#" class="font-bold text-slate-900 underline">Privacy Policy</a>
          </span>
        </label>
      </div>
      ...
      <div class="relative py-4">
        ...
        <div class="relative flex justify-center text-sm">
          <span class="px-3 bg-white text-slate-500 font-bold uppercase tracking-wider">Or sign up with</span>
        </div>
      </div>
