<template>
  <section class="relative py-24 overflow-hidden">
    ...
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full">
      <div class="absolute top-1/2 left-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[120px]"></div>
      <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary/10 rounded-full blur-[120px]"></div>
    </div>

    <div class="container relative z-10 mx-auto px-6 text-center">
      <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-bold mb-8 animate-fade-in-down">
      ...
      <h1 class="text-5xl md:text-7xl font-black text-slate-900 mb-8 leading-[1.1]">
        ...
        <span class="text-transparent bg-clip-text bg-[var(--gradient-primary)]">Tech Enthusiasts</span>
      </h1>
