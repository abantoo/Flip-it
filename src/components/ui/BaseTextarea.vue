  ...
  <div class="space-y-2">
    ...
    <div class="relative group">
      <textarea
        ...
        :rows="rows"
        :required="required"
        class="w-full bg-slate-800/50 border border-slate-700 text-white px-4 py-3 rounded-xl outline-none transition-all duration-300 focus:border-amber-500/50 focus:ring-4 focus:ring-amber-500/10 placeholder:text-slate-500 resize-none"
